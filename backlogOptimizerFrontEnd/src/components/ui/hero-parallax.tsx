...
export const HeroParallax = ({ products }: { products: { title: string; thumbnail: string }[] }) => {
  ...
  return (
    <div ref={ref} className="min-h-screen md:h-[150vh] w-full antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] overflow-hidden">
      <Header />
      <motion.div
        style={{ rotateX, rotateZ, opacity }}
        className="absolute top-[10vh] md:top-0 w-full h-full z-0"
      >
...
export const Header = () => {
  return (
    <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center antialiased relative">
      <div className="p-8 mx-auto relative z-10 w-full pt-80 md:pt-0 sm:pt-16">
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -20 }}
      key={product.title}
      className="group/product md:h-96 md:w-[30rem] h-60 w-[20rem] relative flex-shrink-0"
    >
